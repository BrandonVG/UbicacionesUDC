...
SCRIPT_JQUERY =  pluginPath+"3rdParty/jquery.min.js?ver=27022018",
SCRIPT_ADDGAL =  pluginPath+"3rdParty/ad-gallery/jquery.ad-gallery.js?ver=27022018",
CSS_ADDGAL = pluginPath+"3rdParty/ad-gallery/jquery.ad-gallery.css?ver=27022018",
SCRIPT_FANCYBOX = pluginPath+'3rdParty/fancybox2/jquery.fancybox.pack.js?ver=27022018',
CSS_FANCYBOX = pluginPath+"3rdParty/fancybox2/jquery.fancybox.css?ver=27022018";
...
// 	}
	...
	function updateFramePreview(dialog) {
		...
		var strVar="";
		var jqueryStr = '<script src="'+SCRIPT_JQUERY+'?ver=27022018" type="text/javascript"></script>';
		strVar += "<head>";
//		if (editor.config.slideshowDoNotLoadJquery && (editor.config.slideshowDoNotLoadJquery == true)) {
//			jqueryStr = '';
//		}
		strVar += jqueryStr;
        strVar += "<script type=\"text\/javascript\" src=\""+SCRIPT_ADDGAL+"?ver=27022018\"><\/script>";
        strVar += "<link rel=\"stylesheet\" type=\"text\/css\" href=\""+CSS_ADDGAL+"?ver=27022018\" \/>";
		if ( dialog.params.getVal('openOnClickId') == true) {
			//if (!(editor.config.slideshowDoNotLoadFancyBoxCss && (editor.config.slideshowDoNotLoadFancyBoxCss == true))) {
				strVar += "<link rel=\"stylesheet\" type=\"text\/css\" href=\""+CSS_FANCYBOX+"?ver=27022018\" \/>";
			//}
			//if (!(editor.config.slideshowDoNotLoadFancyBoxScript && (editor.config.slideshowDoNotLoadFancyBoxScript == true))) {
				strVar += "<script type=\"text\/javascript\" src=\""+SCRIPT_FANCYBOX+"?ver=27022018\"><\/script>";
			//}
	...
	function ClickOkBtn(dialog) {
		...
		if ( dialog.params.getVal('openOnClickId') == true) {
			...
			if (!(editor.config.slideshowDoNotLoadFancyBoxCss && (editor.config.slideshowDoNotLoadFancyBoxCss == true))) {
				...
				scriptFancyBoxCss.setText("(function($) { $('head').append('<link rel=\"stylesheet\" href=\""+CSS_FANCYBOX+"?ver=27022018\" type=\"text/css\" />'); })(jQuery);");
		...
		scriptAdGalleryCss.setText("(function($) { $('head').append('<link rel=\"stylesheet\" href=\""+CSS_ADDGAL+"?ver=27022018\" type=\"text/css\" />'); })(jQuery);");
		...
		extraStyles.backgroundColor = '#000000';
