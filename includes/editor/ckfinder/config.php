...
$folder = isset($_SESSION["fck_folder"]) ? $_SESSION["fck_folder"] : "assets/img/ubicaciones/content/basura/";
//$baseUrl = '/content/'.$folder;
$baseUrl = "https://".$_SERVER['SERVER_NAME'].'/ubicaciones/'.$folder;
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => "$baseUrl",
    'root'         => '/htdocs/ubicaciones/home/public_html/'.$folder, // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
